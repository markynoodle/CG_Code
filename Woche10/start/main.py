...
vertex_shader_source_triangle = read_shader_source(r'C:\CG_Code\Woche10\start\shaders\triangle.vertex')
fragment_shader_source_triangle = read_shader_source(r'C:\CG_Code\Woche10\start\shaders\triangle.fragment')
